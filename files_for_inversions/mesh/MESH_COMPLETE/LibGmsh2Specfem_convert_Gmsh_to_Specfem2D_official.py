...
def OuvreGmsh(Dir,Nom,Bords):
    ...
    SauvFicSpecfem('nodes_coords_file', NbNodes, Nodes, '%f')
    # Elements
    DecElem=12+NbNodes
...
#
    ...
    #-----------------------------------------------------------------------
    # Save to SPECFEM format
    SauvFicSpecfem('mesh_file', N2D, Elements, '%i')
    #
    SauvFicSpecfem('absorbing_surface_file', cta, Elements2DBordAbso, '%i')
    #
    SauvFicSpecfem('free_surface_file', ctf, Elements2DBordFree, '%i')
    #
