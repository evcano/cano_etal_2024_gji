...
FIGPATH_1=""
OBSDIR_1="inversions_noise_model_2/anat/data_obs"
INIDIR_1="inversions_noise_model_2/anat/output/solver_01"
FINDIR_1="inversions_noise_model_2/anat/output/solver_18"
FLAGS_1="--name --misf --filt 0.02 0.09 --tlim 0 340 --norm --win"

FIGPATH_2=""
OBSDIR_2="inversions_noise_model_2/fwani/data_obs"
INIDIR_2="inversions_noise_model_2/fwani/output/solver_01"
FINDIR_2="inversions_noise_model_2/fwani/output/solver_25"
FLAGS_2="--name --misf --filt 0.02 0.09 --tlim -170 170 --corr --norm --win"

FIGPATH_3=""
OBSDIR_3="inversions_noise_model_2/fdfwani/data_obs"
INIDIR_3="inversions_noise_model_2/fdfwani/output/solver_01"
FINDIR_3="inversions_noise_model_2/fdfwani/output/solver_28"
